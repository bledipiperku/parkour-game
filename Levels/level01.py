...
class Level01(Entity):
    def __init__(self):
        ...
        self.block_1_8 = JumpBlock((827.6, 24, -48), (0, -122.183, 0))

        self.block_1_9 = JumpBlock((787.3, 27, -96.4), (0, -179, 0))
    ...
    def update(self):
        ...
        if hit.entity == self.block_1_23:
            self.player.jump_height = 1.3
        elif hit.entity == self.block_1_8:
            self.player.jump_height = 2
        elif hit.entity == self.block_1_9:
            self.player.jump_height = normalJump 
