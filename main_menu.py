...
class MainMenu(Entity):
    def __init__(self):
        ...
        def level02_menu():
            ...
            self.player.enable()
            self.player.time_running = True
            self.player.position = (827, 22, 108)
            self.player.rotation = (0, -267, 0)
            mouse.locked = True
        ...
        level08 = Button(text = "End", color = color.black, scale_y = 0.1, scale_x = 0.3, y = -0.3, x = 0, parent = self.levels_menu)
